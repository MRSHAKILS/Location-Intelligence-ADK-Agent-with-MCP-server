...
- [**Google Remote MCP Guide**](./Google%20remote%20MCP.md) (`/Google remote MCP.md`)**:** Step-by-step guide for building a Location Intelligence ADK agent with BigQuery, Google Maps, and MCP, including screenshots.
